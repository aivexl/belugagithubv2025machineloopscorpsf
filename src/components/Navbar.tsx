  ...
  return (
    <>
      ...
      <header ref={headerRef} className="fixed top-0 left-0 right-0 z-50 bg-black/40 backdrop-blur-xl backdrop-saturate-150 shadow-lg xl:left-20">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 md:px-6 lg:px-8 py-5 sm:py-6 md:py-7 lg:py-8 tablet-container xl:justify-start xl:space-x-8">
